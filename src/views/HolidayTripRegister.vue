    ...
    <el-dialog  
      ...
      <span slot="title">
        ...
        <div class="dialogRow">
          ...
          <el-input
            placeholder="请输入 省-市-区（如江苏省-南京市-栖霞区）"
            v-model="newTarget">
          </el-input>
        </div>
        <div class="dialogRow">
          ...
          <el-input
            v-model="newEmergencyPeople">
          </el-input>
        </div>
        <div class="dialogRow">
           <p class="index">应急联系方式：</p>
          <el-input
            v-model="newEmergencyContact">
          </el-input>
        </div>
        <div class="dialogRow">
           <span class="index">是否离开南京：</span>
            <el-button v-if="newIsNanjing" type="success" icon="el-icon-check" circle @click="newIsNanjing = false" size="small"></el-button>
            <el-button v-if="!newIsNanjing" type="danger" icon="el-icon-close" circle @click="newIsNanjing = true" size="small"></el-button>
        </div>
...
import { Timeline,TimelineItem,Card,Dialog,Divider,RadioGroup,RadioButton,DatePicker } from "element-ui";
